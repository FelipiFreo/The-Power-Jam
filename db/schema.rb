...
ActiveRecord::Schema[7.1].define(version: 2024_02_25_033259) do
  ...
  create_table "jams", force: :cascade do |t|
    ...
    t.time "jam_start"
    t.time "jam_finish"
    t.bigint "jam_finished_by_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id"], name: "index_jams_on_game_id"
    t.index ["jam_finished_by_id"], name: "index_jams_on_jam_finished_by_id"
    t.index ["line_up_id"], name: "index_jams_on_line_up_id"
  end
  ...
  add_foreign_key "jams", "games"
  add_foreign_key "jams", "jam_finished_bies"
  add_foreign_key "jams", "line_ups"
